...
public class EasyByteCoderResourceObjectPool {
    ...
    public static void init(URLClassLoader classLoader) {
      ...
      //  getFromCache(EasyByteCoderConstants.EasyByteCoder_SERIALIZER_HESSIAN_CLASS);
    ...
    public static HessianSerializer getHessianSerializer() {
        return (HessianSerializer) getFromCache(EasyByteCoderConstants.EasyByteCoder_SERIALIZER_HESSIAN_CLASS);
    }
